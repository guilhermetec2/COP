...
<body>
    ...
    <main class="w3-container">
        <section class="area">
            ...
            <h2 class="w3-margin-bottom w3-margin-left"><i class="fa fa-pencil-square-o w3-xxlarge"></i> Cadastrar Ordem</h2>     
           
            <section class="w3-card-4 w3-white folha-edit w3-margin-bottom">
                
                <form class="w3-container" action="">
                    <label for="">Numero da Ordem:</label>
                    <input type="number" class="w3-input w3-border w3-margin-bottom" required>
                    <label for="">Técinco:</label>
                    <select class="w3-select w3-border" name="tecnico" required>
                    ...
                    <input type="date" class="w3-input w3-border" required>
                ...
                <p>
                    <!-- Trocas este link por um input:submit -->
